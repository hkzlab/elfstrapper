...
$(BINDIR)/$(PROGNAME):	$(BINDIR)/main.o $(BINDIR)/parport.o $(BINDIR)/elf.o $(BINDIR)/utils.o
	$(CC) $(CFLAGS)	$(BINDIR)/main.o $(BINDIR)/parport.o $(BINDIR)/elf.o $(BINDIR)/utils.o -o $(BINDIR)/$(PROGNAME) 
